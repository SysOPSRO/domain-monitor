...
LABEL org.opencontainers.image.documentation=https://github.com/sysopsro/domain-monitor
...
LABEL org.opencontainers.image.source=https://github.com/sysopsro/domain-monitor
