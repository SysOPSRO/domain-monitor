...
[![Test Build Go Project](https://github.com/sysopsro/domain-monitor/actions/workflows/go.yml/badge.svg)](https://github.com/sysopsro/domain-monitor/actions/workflows/go.yml)
![GitHub go.mod Go version](https://img.shields.io/github/go-mod/go-version/sysopsro/domain-monitor?style=flat)
![GitHub package.json version](https://img.shields.io/github/package-json/v/sysopsro/domain-monitor?style=flat)
...
#### Using [Github Packages](https://github.com/sysopsro/domain-monitor/packages/)

`docker run -p 127.0.0.1:3124:3124 -v ./data:/app/data ghcr.io/sysopsro/domain-monitor:1`
...
services:
  dm:
    image: ghcr.io/sysopsro/domain-monitor:1
    ports:
...
#### Using [Docker Hub](https://hub.docker.com/repository/docker/sysopsro/domain-monitor)

Image is just `sysopsro/domain-monitor`, latest tag will be the most recent version, or pull by tagged version. The most recent old (non-go) version is tagged with `0.3.4`.

`docker run -p 127.0.0.1:3124:3124 -v ./data:/app/data docker.io/sysopsro/domain-monitor`
