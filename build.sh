...
# "https://github.com/sysopsro/domain-monitor" into this "domain-monitor"
...
podman build \
    ...
    --annotation="org.opencontainers.image.documentation=https://github.com/sysopsro/domain-monitor" \
    ...
    --annotation="org.opencontainers.image.source=https://github.com/sysopsro/domain-monitor" \
